	...
	return (
		<>
			...
			<div className="mobile-bottom-bar">
				<a href="/" className="mobile-bottom-item">
					<img src="/airbnb.png" alt="home" className="mobile-bottom-icon" />
					<span>Home</span>
				</a>
				<button className="mobile-bottom-item" onClick={() => navigate('/')}>
					<span className="mobile-bottom-item">
						<img src="/map.svg" alt="map" className="mobile-bottom-icon" />
					</span>
					<span>Trips</span>
				</button>
				<button className="mobile-bottom-item" onClick={() => navigate('/login')}>
					<img src="/user.png" alt="profile" className="mobile-bottom-icon" />
